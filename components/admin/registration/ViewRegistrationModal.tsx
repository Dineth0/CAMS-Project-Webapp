    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between p-5 border-b border-slate-800 bg-slate-950/40">
          ...
          <button onClick={onClose} className="p-2 cursor-pointer text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 rounded-xl transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-slate-800 cursor-pointer bg-slate-950/40 flex justify-end">
